...
//用户ID验证 
jQuery.validator.addMethod("charnumother", function(value, element) { 
	var length = value.length; 
	var charnumother = /[A-Za-z0-9-]+$/;
	return this.optional(element) || (charnumother.test(value)); 
}, "只能是数字、字母和横线"); 

// 只能输入字母和数字
jQuery.validator.addMethod("numandchar", function(value, element) { 
	var length = value.length; 
	var numandchar = /[A-Za-z0-9]+$/;
	return this.optional(element) || (numandchar.test(value)); 
	}, "只能输入字母和数字"); 
// 手机号码验证 
...
jQuery.validator.addMethod("phone", function(value, element) { 
	...
	//var tel = /^(0[0-9]{2,3}\-)?([0-9][0-9][0-9][0-9]{5,6,7,8})+(\-[0-9]{1,4})?$/; 
	var tel = /^[0-9\-]*$/;
	return this.optional(element) || (tel.test(value)); 
	}, "电话号码格式错误");
